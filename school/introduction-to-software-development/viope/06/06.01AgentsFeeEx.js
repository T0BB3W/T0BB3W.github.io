function calculateFee() {
	...
	let input = Number(document.getElementById("price").value);

	// Calculate fee, save the result to a variable
	let fee = input * 0.0344;
	...
	document.getElementById("fee").innerHTML = "Real estate agent's fee is " + fee.toFixed(2) + " euros";		
